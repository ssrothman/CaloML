...
# with command line options: step4 --filein GSD.root --fileout RECO.root --mc --eventcontent FEVTDEBUG --datatier GEN-SIM-RECO --step RAW2DIGI,L1Reco,RECO,RECOSIM --conditions auto:phase1_2024_realistic --era Run3_2024 --no_exec --python_filename=CaloML/Processing/test/RECO_Run3.py
