...
# with command line options: step3 --conditions auto:phase1_2025_realistic -n10 --era Run3 --filein file:test.root --fileout testNanoML.root --mc --eventcontent NANOAODSIM --step NANO --no_exec
# plus some additional customizations, which can probably be added to the cmsDriver command?
