...
# with command line options: Configuration/Generator/python/SinglePiPt10_pythia8_cfi.py --fileout GSD.root --mc --eventcontent FEVTDEBUG --datatier GEN-SIM-DIGI-RAW --step GEN,SIM,DIGI,L1TrackTrigger,L1,L1P2GT,DIGI2RAW,HLT:@relvalRun4 --geometry ExtendedRun4D110 --conditions auto:phase2_realistic_T33_13TeV --era Phase2C17I13M9 --beamspot NoSmear --no_exec --python_filename=CaloML/Processing/test/GSD_Run4.py --customise CaloML/Processing/customize_generator_cff.customize_particle_gun
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/Generator/python/SinglePiPt10_pythia8_cfi.py nevts:1'),
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('/home/submit/srothman/cmsdata/CaloML/testing/GSD_Run4_TauGun_Endcaps.root'),
...
# Automatic addition of the customisation function from CaloML.Processing.customize_generator_cff
from CaloML.Processing.customize_generator_cff import customize_particle_gun 

#call to customisation function customize_particle_gun imported from CaloML.Processing.customize_generator_cff
process = customize_particle_gun(process)
...
#setup generator to be a pion gun pointing at the endcaps
process.generator.PGunParameters.ParticleID = cms.vint32(15)
process.generator.PGunParameters.MinEta = cms.double(1.5)
