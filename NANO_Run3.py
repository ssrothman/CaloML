...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://eosuser.cern.ch//eos/user/c/chtong/Public/Rereco/SinglePiPt100_1000_n1000/pf_only_reReco_MC_Sim_new.root'),
    #fileNames = cms.untracked.vstring('root://eosuser.cern.ch//eos/user/c/chtong/Public/Rereco/ttbar_rereco/pf_only_reReco_MC_Sim_new_timing.root'),
...
process = setupSimTruth(process, 'HCAL', verbose=0)
process = setupSimTruthTables(process, 'HCAL')
process = setupSimHitTables(process, 'HCAL')
process = setupRecHitTables(process, 'HBHE', 'HCAL')
process = setupRecHitTables(process, 'HO', 'HCAL')
...
from CaloML.PFClusters.ClusterTables_cff import setupClusterTables # pyright: ignore[reportMissingImports]

setupClusterTables(
    process,
    src='particleFlowClusterHCAL',
    clusterTableName='HcalClusterTable',
    clusterHitsTableName='HcalClusterHitsTable',
    doc='HCAL'
)
